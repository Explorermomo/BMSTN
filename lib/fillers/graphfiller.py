...
from . import Filler
from ..nn.models import MPGRUNet, BiMPGRUNet, GRINet, AMSTNet, gwnet
...
class GraphFiller(Filler):
    ...
    def __init__(self,
        ...
        elif model_class in [BiMPGRUNet, GRINet, AMSTNet, gwnet]:
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss = self.loss_fn(imputation, target)

        for pred in predictions:
            loss += self.tradeoff * self.loss_fn(pred, target)
